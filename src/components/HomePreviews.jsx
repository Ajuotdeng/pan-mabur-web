...
const HomePreviews = () => {
  ...
  return (
    <div className="grid grid-cols-1 gap-4 mt-8 font-serif md:grid-cols-2">
      <div className="md:col-span-2">
        ...
        >
          ...
          {firstBlog && (
            <div className="flex flex-col w-full max-w-xl p-4 mx-auto mt-6 font-serif bg-white rounded-lg shadow">
              <img
                src={firstBlog.image}
                alt={firstBlog.title}
              ...
              <Link
                ...
                className="self-start font-serif text-blue-600 hover:underline"
              >
                Read more &rarr;
              </Link>
            </div>
