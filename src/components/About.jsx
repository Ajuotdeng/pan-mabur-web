...
const About = () => (
  <div className="max-w-5xl px-4 py-8 mx-auto text-center">
    <Section title="Pan Mabur Origin">
      <div className="min-h-screen px-4 py-10 md:px-14">
        <h2 className="mb-8 text-3xl font-bold leading-relaxed text-blue-800 md:text-4xl font-inter">
          Pan Mabur: A Legacy of Kinship
        </h2>
        <img
          src={maburImage}
          alt="Pan Mabur family"
          className="object-contain w-full h-auto max-w-3xl mx-auto shadow-lg rounded-xl"
        />
        <div className="max-w-3xl mx-auto">
          <p className="mt-6 text-base leading-relaxed md:text-lg md:leading-loose">
    ...
    <Section title="Cultural Practices & Norms">
      <div className="max-w-3xl mx-auto">
        ...
        <p className="mt-4 text-base leading-relaxed md:text-lg md:leading-loose">
      ...
      <img
        src={dukImage}
        alt="cattle"
        className="object-contain w-full h-auto max-w-3xl mx-auto mt-8 shadow-lg rounded-xl"
      />
    </Section>
