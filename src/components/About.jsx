...
const About = () => (
  <div className="max-w-6xl px-6 py-12 mx-auto space-y-16 text-center">
    <Section title="Pan Mabur Origin">
      <div className="min-h-screen px-6 py-12 md:px-16">
        <h2 className="mb-10 text-3xl font-semibold leading-snug text-blue-800 md:text-4xl font-inter">
    ...
    <Section title="Cultural Practices & Norms">
      <div className="max-w-3xl mx-auto space-y-6 text-left">
        <p className="text-base leading-loose tracking-wide text-gray-800 md:text-lg md:leading-relaxed">
