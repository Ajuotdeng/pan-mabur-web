...
const data = {
  name: "Nyakoang Malual",
  attributes: { title: "Granddaughter" },
  children: [
    {
      name: ". ",
      attributes: { title: "Husband of Nyakoang" },
      children: [
        { name: "Akuol Nyakoang", attributes: { title: "Great Granddaughter" } },
      ],
    },
  ],
};

export default function NyakoangMalual() {
  ...
  return (
    <div className="flex flex-col items-center min-h-screen px-4 py-10 bg-gray-50">
      <h1 className="mb-6 text-3xl font-bold text-green-700">
        Descendants of Nyakoang Malual
      </h1>
