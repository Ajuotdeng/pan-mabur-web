...
const data = {
  ...
  children: [
    {
      name: "Nyaring Mabior Deng ",
      attributes: { title: "Wife of Akoi Malual" },
      children: [
        { name: "Nyanman Magot", attributes: { title: "Great Granddaughter" } },
        { name: "Nyantet Magot", attributes: { title: "Great Granddaughter" } },
        { name: "Ajuot Magot", attributes: { title: "Great Grandson" } },
      ],
    },
  ],
};
